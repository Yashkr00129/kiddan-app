			...
			<ScrollView>
				...
				<View style={styles.textContainer}>
					...
					<Text style={styles.articleText}>
						New Delhi, India - Four months after losing its majority in
						parliament for the first time in a decade, Prime Minister Narendra
						Modi's Bharatiya Janata Party (BJP) secured a record third term in
						the northern state of Haryana and scored its best ever performance
						in Indian-administered Kashmir, marking a dramatic turnaround. The
